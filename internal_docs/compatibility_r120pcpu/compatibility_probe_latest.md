...
- JSON: internal_docs\compatibility_r120pcpu\compatibility_probe_latest.json

| Item | Status | Detail |
|---|---|---|
| 3e/ql 0101 Read Type Name | OK | type_name=OK (model=R120PCPU, model_code=0x4844 (18500)) |
...
| 3e/iqr 0101 Read Type Name | OK | type_name=OK (model=R120PCPU, model_code=0x4844 (18500)) |
...
| 4e/ql 0101 Read Type Name | OK | type_name=OK (model=R120PCPU, model_code=0x4844 (18500)) |
...
| 4e/iqr 0101 Read Type Name | OK | type_name=OK (model=R120PCPU, model_code=0x4844 (18500)) |
