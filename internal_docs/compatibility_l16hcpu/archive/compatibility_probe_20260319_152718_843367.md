...
- JSON: internal_docs\compatibility_l16hcpu\compatibility_probe_latest.json

| Item | Status | Detail |
|---|---|---|
| 3e/ql 0101 Read Type Name | OK | type_name=OK (model=L16HCPU, model_code=0x48C2 (18626)) |
...
| 3e/iqr 0101 Read Type Name | OK | type_name=OK (model=L16HCPU, model_code=0x48C2 (18626)) |
...
| 4e/ql 0101 Read Type Name | OK | type_name=OK (model=L16HCPU, model_code=0x48C2 (18626)) |
...
| 4e/iqr 0101 Read Type Name | OK | type_name=OK (model=L16HCPU, model_code=0x48C2 (18626)) |
