...
- the byte-level layout difference for `G/HG` is documented in maintainer archive
- the Q/L-style `U01\G22` capture evidence is documented in maintainer archive
