...
| writeBlock mixed | NG | 0xC056 | no | 1 | after_words=[0x0000, 0x0000], after_bits=[0x0000], request_count=1 |
...
- Warnings: none
- Error: SLMP error end_code=0xC056 command=0x1406 subcommand=0x0000

```text
attempt 1: end_code=0xC056
...
response: D4 00 0C 00 00 00 00 FF FF 03 00 0B 00 56 C0 00 FF FF 03 00 06 14 00 00
```
