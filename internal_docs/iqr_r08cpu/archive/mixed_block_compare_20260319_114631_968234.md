...
| writeBlock mixed | NG | 0xC05B | no | 1 | after_words=[0x0000, 0x0000], after_bits=[0x0000], request_count=1 |
...
- Warnings: none
- Error: SLMP error end_code=0xC05B command=0x1406 subcommand=0x0002
