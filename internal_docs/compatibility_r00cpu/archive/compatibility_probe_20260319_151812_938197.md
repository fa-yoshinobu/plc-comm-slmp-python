...
- JSON: internal_docs\compatibility_r00cpu\compatibility_probe_latest.json

| Item | Status | Detail |
|---|---|---|
| 3e/ql 0101 Read Type Name | OK | type_name=OK (model=R00CPU, model_code=0x48A0 (18592)) |
...
| 3e/iqr 0101 Read Type Name | OK | type_name=OK (model=R00CPU, model_code=0x48A0 (18592)) |
...
| 4e/ql 0101 Read Type Name | OK | type_name=OK (model=R00CPU, model_code=0x48A0 (18592)) |
...
| 4e/iqr 0101 Read Type Name | OK | type_name=OK (model=R00CPU, model_code=0x48A0 (18592)) |
