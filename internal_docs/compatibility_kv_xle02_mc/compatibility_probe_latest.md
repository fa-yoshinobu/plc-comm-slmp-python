...
- Date: 2026-03-19 15:43:33
- PLC Label: KV_XLE02_MC
...
- Summary: OK=18, PARTIAL=0, NG=14, SKIP=0
- JSON: internal_docs\compatibility_kv_xle02_mc\compatibility_probe_latest.json

| Item | Status | Detail |
|---|---|---|
| 3e/ql 0101 Read Type Name | OK | type_name=OK (model=V7500, model_code=0x0037 (55)) |
...
| 3e/ql 0613 Buffer Read | NG | memory_read=NG (SLMP error end_code=0xC056 command=0x0613 subcommand=0x0000) |
| 3e/iqr 0101 Read Type Name | OK | type_name=OK (model=V7500, model_code=0x0037 (55)) |
...
| 3e/iqr 0613 Buffer Read | NG | memory_read=NG (SLMP error end_code=0xC056 command=0x0613 subcommand=0x0000) |
| 4e/ql 0101 Read Type Name | OK | type_name=OK (model=V7500, model_code=0x0037 (55)) |
...
| 4e/ql 0613 Buffer Read | NG | memory_read=NG (SLMP error end_code=0xC056 command=0x0613 subcommand=0x0000) |
| 4e/iqr 0101 Read Type Name | OK | type_name=OK (model=V7500, model_code=0x0037 (55)) |
...
| 4e/iqr 0613 Buffer Read | NG | memory_read=NG (SLMP error end_code=0xC056 command=0x0613 subcommand=0x0000) |
