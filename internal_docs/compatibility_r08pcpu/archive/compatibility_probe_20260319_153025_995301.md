...
- JSON: internal_docs\compatibility_r08pcpu\compatibility_probe_latest.json

| Item | Status | Detail |
|---|---|---|
| 3e/ql 0101 Read Type Name | OK | type_name=OK (model=R08PCPU, model_code=0x4841 (18497)) |
...
| 3e/iqr 0101 Read Type Name | OK | type_name=OK (model=R08PCPU, model_code=0x4841 (18497)) |
...
| 4e/ql 0101 Read Type Name | OK | type_name=OK (model=R08PCPU, model_code=0x4841 (18497)) |
...
| 4e/iqr 0101 Read Type Name | OK | type_name=OK (model=R08PCPU, model_code=0x4841 (18497)) |
